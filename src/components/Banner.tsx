...
const Banner = ({ theme }: { theme: "light" | "dark" }) => (
  <section
    className="relative flex flex-col items-center justify-center overflow-hidden px-4 pb-10 pt-4 before:absolute before:inset-x-0 before:bottom-0 before:z-[1] before:h-20 before:bg-gradient-to-t before:from-[#eef2ed] before:to-transparent dark:before:from-[#111827] sm:flex-row sm:gap-3 sm:pb-12 sm:pt-6"
  >
    <ShaderBackground theme={theme} variant="banner" />
    <a
