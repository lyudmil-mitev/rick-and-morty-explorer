                        ...
                        {tabs.map((tab) => {
                            ...
                            return (
                                <Link
                                    key={tab}
                                    to={`/${tab.toLowerCase()}`}
                                    className={`portal-hover relative mx-1 rounded-full px-6 py-3 text-sm font-bold tracking-wide transition duration-200 ${isSelected
                                        ? "bg-lime-300 text-gray-950 shadow-lg shadow-lime-300/30"
                                        : "text-gray-300 hover:text-white hover:[text-shadow:0_0_8px_rgba(255,255,255,0.9)]"
                                    }`}
