    ...
    return (
        <div className="absolute bottom-0 left-1/2 z-20 w-full max-w-[calc(100vw-1.5rem)] -translate-x-1/2 translate-y-1/2 px-3 sm:w-fit sm:max-w-none sm:px-4">
            <div className="mx-auto w-fit max-w-full">
                <nav className="inline-flex max-w-full rounded-lg border border-cyan-700/20 bg-[#fbfaf2]/88 p-1.5 shadow-2xl shadow-cyan-950/10 backdrop-blur dark:border-cyan-300/25 dark:bg-slate-950/90 dark:shadow-lime-300/10 sm:p-2" aria-label="Main sections">
                    {tabs.map((tab) => {
